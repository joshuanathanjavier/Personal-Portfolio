  ...
  return (
    <div>
        ...
        <div className='flex flex-col md:flex-row items-center'>
            ...
            <Link className="hover:text-[#6dbfb8] hover:scale-110 transition-transform duration-300 ease-out" href="https://sanctuarysounds.vercel.app/" target="_blank" rel="noopener noreferrer"><h3 className="text-2xl flex flex-row items-center gap-1">Sanctuary<ExternalLink size="20"/></h3></Link>
